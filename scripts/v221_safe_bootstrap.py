"""Sterile, source-only launcher for the v2.21 dual-view RRF G0 probe.
...
PROJECT_ROOT = "D:/tiktok/techjam-v2-21-gloss-g0"
RUNTIME_BASE = "D:/tiktok/.v221_runtime"
...
BOOTSTRAP_WORKTREE_PATH = (
    PROJECT_ROOT + "/scripts/v221_safe_bootstrap.py"
)

RUNNER_PATH = PROJECT_ROOT + "/scripts/probe_sparse_union_g0.py"
...
ATTESTATION_ATTRIBUTE = "_techjam_v221_bootstrap_attestation"
...
_LOCAL_SOURCE_ROWS = {
    ...
    "starter.sparse_union_g0": (
        ...
        "1d8450b7b80e52126acd2ec468b0faacd538587d",
        False,
    ),
}
...
def _validate_early_runtime(target: dict[str, str], target_arguments: tuple[str, ...]) -> dict[str, str]:
    ...
    if target["mode"] == "direct":
        ...
        if not (
            ...
            == _path_key(os.path.join(bootstrap_root, "v221_safe_bootstrap.py"))
...
def _bootstrap_main(raw_arguments: list[str]) -> int:
    ...
    if target["mode"] == "module":
        ...
        if os.listdir(bootstrap_root) != ["v221_safe_bootstrap.py"]:
