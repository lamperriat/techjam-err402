...
def test_global_comparator_gate_width_matches_pinned_legacy_helper() -> None:
    from scripts import train_small_ranker as legacy

    assert len(legacy.GATE_FEATURE_NAMES) == 25
    assert subject.GATE_FEATURE_COUNT == len(legacy.GATE_FEATURE_NAMES)
