...
from .reranker import RERANK_TOP_N, SCORER_VERSION, rerank_top_n
from .slot_ledger import (
    SCHEMA_VERSION as SLOT_LEDGER_SCHEMA_VERSION,
    DELETED,
    SUPERSEDED,
    SlotLedger,
)
from .versioned_pagination import (
...
class Agent:
    ...
    def __init__(
        ...
        if self.p11_mode in {"shadow", "active"}:
            try:
                from .p11_bridge import P11ProductionBridge
        ...
        if self.small_ranker_mode in {"shadow", "active"}:
            if (
                ...
                try:
                    from .p11_bridge import DEFAULT_SIDECAR
                    from .small_ranker import SmallRankerRuntime
    ...
    def _apply_small_ranker(
        ...
        try:
            ...
            from .p11_bridge import _latest_hard_clause_terms
